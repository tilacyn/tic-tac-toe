...
class BoardStore(private val lobbyConnections: MutableSet<Connection> = ConcurrentSet(),
...
//            }
    ...
    operator fun set(id: String, board: Board) {
        ...
        println("added, sending messages")
        changed()
        println("added, sent messages")
    }

    fun addEmptyBoard(user: String): Board {
